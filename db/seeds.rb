...
job3 = Job.create(:comp_name => 'trafigura', :title => 'senior operation executive', :location => '2 marina boulevard', :salary => '$2,000 - 2,999', :url => 'www.jobs.sg.gov', :deadline => "2019-11-20", :interview => "2019-12-02", :status => '1st Interview', :ind => 'shipping', :user_id => '1', :stat_index => 3)

job4 = Job.create(:comp_name => 'revitalize', :title => 'admin exe', :location => '23 hello rd', :salary => '$0 - 1,999', :url => 'www.monster.com', :deadline => "2019-10-01", :interview => "2019-11-09", :status => '2nd Interview', :ind => 'health', :user_id => '1', :stat_index => 4)

job5 = Job.create(:comp_name => 'Kgroup', :title => 'instructor', :location => '3 bugis st', :salary => '$3,000 - 3,999', :url => 'www.indeed.com', :deadline => "2019-10-20", :interview => "2019-10-30", :status => '1st Interview', :interview => "2019-11-14", :ind => 'health', :user_id => '1', :stat_index => 3)
...
job5 = Job.create(:comp_name => 'shangrila', :title => 'manager', :location => '47 Ordain Rd', :salary => '$0 - 1,999', :url => 'www.jobstreet.com', :deadline => "2019-10-30", :status => '2nd Interview', :interview => "2019-11-26",:ind => 'food', :user_id => '1', :stat_index => 4)
